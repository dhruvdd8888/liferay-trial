...
public interface AuditLogsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.aixtor.meepay.audit.management.service.impl.AuditLogsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the audit logs local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuditLogsLocalServiceUtil} if injection and service tracking are not available.
	 */
