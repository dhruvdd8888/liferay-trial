...
import com.aixtor.meepay.crud.models.EmployeeWebModel;
...
@Component(immediate = true, property = {
		...
		"mvc.command.name=/renderEmployeeFormPrefill"
}, service = MVCRenderCommand.class)
public class ViewFormPrefillMVCRenderCommand implements MVCRenderCommand {
	@Reference
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		long employeeId = ParamUtil.getLong(renderRequest, MeepayEmployeeConstants.EMPLOYEE_ID);
		...
		renderRequest.setAttribute(MeepayEmployeeConstants.EMPLOYYEE_PREFILL, employeeWebModel);
