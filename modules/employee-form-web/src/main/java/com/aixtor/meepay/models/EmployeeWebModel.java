...
public class EmployeeWebModel {
	...
	public EmployeeWebModel(Employee employee){
		...
		department = EmployeeList.departmentMap.get(departmentId);
		branchId = employee.getBranchId();
		branch =  EmployeeList.branchMap.get(branchId);
		designationId = employee.getDesignationId();
		designation =  EmployeeList.designationMap.get(designationId);
	...
	public EmployeeWebModel(Object object){
		...
		try {
			...
			System.out.println("cannnnntntntnnt");
		}
	}
