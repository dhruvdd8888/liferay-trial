	...
	<c:otherwise>
		...
		<div class="login-container">
			...
			<aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form" method="post" name="<%= formName %>" onSubmit="event.preventDefault();" validateOnBlur="<%= false %>">
				...
				<br><br>
				<aui:button-row>
					<button type="button" class = "btn btn-primary" href = "http://localhost:8080/web/meepay" >Skip Login</button><p style="display: inline;">&lt;--- This is all beacuse of fragement hook override</p>
				</aui:button-row>
			</aui:form>
